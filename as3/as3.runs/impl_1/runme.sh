...
HD_PWD='C:/Users/ntyythepro/Verilog/W5/as3/as3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log as3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source as3.tcl -notrace
