...
HD_PWD='C:/Users/ntyythepro/Verilog/W5/as3/as3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log as3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source as3.tcl
