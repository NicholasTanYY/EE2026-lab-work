...
HD_PWD='C:/Users/ntyythepro/Verilog/W2/assignment1/assignment1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log as1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source as1.tcl -notrace
