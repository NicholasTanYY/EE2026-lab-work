...
HD_PWD='C:/Users/ntyythepro/Verilog/W2/assignment1/assignment1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log as1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source as1.tcl
